...
/**
 * Why we could use double pointers to handle problems pertaining to subarray?
 * Because sliding windows implies the a cetrain way of state change of the window!
 */

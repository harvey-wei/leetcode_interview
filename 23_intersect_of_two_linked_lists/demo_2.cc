...
public:
    ListNode* get_cycle_entrance(ListNode* head)
    {
         ...
         * a + b + kc = 2(a + b) => a + b = kc
         * 1. Slower tortoise walks exactly the same edges of cycle.
         * 2. Faster walks from first meeting point another non-cyclic # of edges and reach the
         entrance.
         * 3. Reset the slower to dummy head
         */

...
public:
    int lengthOfLongestSubstring(string s)
    {
        /* Time: O(N)
           ...
           For double pointers, you should count # of moving steps of both pointers.
        */
        ...
        */
        ...
        /* Both left and right start at 0. */
        /* Check each substring (sliding window) ending at right.*/
